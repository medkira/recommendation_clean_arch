...
export interface UpdatePostInterface extends UseCase<UpdatePostInterface.Request, UpdatePostInterface.Rsponse> {
    execute(params: UpdatePostInterface.Request): Promise<UpdatePostInterface.Rsponse>
}
